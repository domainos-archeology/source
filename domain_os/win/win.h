 ...
 * Internal functions
 */
extern status_$t SEEK(uint16_t unit, uint16_t cylinder, void *req, uint8_t flags);
...
extern void DISK__REGISTER(void *type, void *ctrl, void *flags,
                           void *dev_type, void **jump_table);
extern void DISK__SORT(void *dev_entry, void **queue_ptr);
extern uint32_t DISK_INIT(uint16_t unit, uint16_t vol_idx, void *p3,
