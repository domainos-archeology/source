...
|   20 29 00 10    move.l (0x10,A1),D0  (arg4)
|   b2 80          cmp.l D0,D1
...
|   4e 90          jsr (A0)
|   de fc 00 10    adda.w #0x10,SP      (cleanup 4 args = 16 bytes)
...
SVC_$TRAP4:
        cmp.w   #0x83,%d0               | Check syscall number limit (<131)
