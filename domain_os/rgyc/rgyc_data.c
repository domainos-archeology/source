...
uid_t RGYC_$P_SYS_USER_UID = UID_CONST(0x00000500, 0);

/* System project UID - Address: 0xE17424 */
uid_t RGYC_$G_SYS_PROJ_UID = UID_CONST(0x00000540, 0);

/* System org UID - Address: 0xE1743C */
uid_t RGYC_$O_SYS_ORG_UID = UID_CONST(0x00000580, 0);
...
uid_t RGYC_$G_LOGIN_UID = UID_CONST(0x00000541, 0);

/* Locksmith (superuser) UID - Address: 0xE17434 */
uid_t RGYC_$G_LOCKSMITH_UID = UID_CONST(0x00000542, 0);
...
uid_t RGYC_$P_USER_UID = UID_CONST(0x00800001, 0);

/* Daemon UID - Address: 0xE17514 */
uid_t RGYC_$P_DAEMON_UID = UID_CONST(0x00800005, 0);

/* System admin group UID - Address: 0xE1752C */
uid_t RGYC_$G_SYS_ADMIN_UID = UID_CONST(0x00800041, 0);
