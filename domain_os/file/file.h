 ...
 */
#define status_$file_object_not_found                   0x000F0001  /* Object not found */
#define status_$file_object_is_remote                   0x000F0002  /* Object is remote */
#define status_$file_bad_reply_received_from_remote     0x000F0003  /* Bad reply from remote */
#define status_$file_object_not_locked_by_this_process  0x000F0005  /* Not locked by this process */
#define status_$file_object_in_use                      0x000F0006  /* Object in use */
#define status_$file_illegal_lock_request               0x000F0008  /* Illegal lock request */
#define status_$file_local_lock_table_full              0x000F0009  /* Lock table full */
#define status_$file_cannot_create_on_remote_with_uid   0x000F000B  /* Cannot create on remote with UID */
#define status_$file_obj_not_locked_by_this_process     0x000F000C  /* Not locked by this process (alt) */
#define status_$file_objects_on_different_volumes       0x000F0013  /* Objects on different volumes */
#define status_$file_invalid_arg                        0x000F0014  /* Invalid argument */
#define status_$file_incompatible_request               0x000F0015  /* Incompatible request */
#define status_$file_invalid_type                       0x000F0016  /* Invalid type */
#define status_$file_op_cannot_perform_here             0x000F0018  /* Cannot perform operation here */
#define status_$file_vol_mounted_read_only              0x000E0030  /* Volume is read-only */
